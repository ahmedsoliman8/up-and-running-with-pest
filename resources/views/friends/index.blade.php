    ...
    @auth
        ...
        <div class="space-y-6">
            ...
            <div>
                ...
                <form action="/friends" method="post" class="mt-4 space-y-4">
                    ...
                    <div class="space-y-1">
                        ...
                        <input type="email" name="email" id="email" placeholder="e.g. you@somewhere.com"
            ...
            @if($pendingFriends->count())
                <div>
                    <h1 class="font-bold text-xl text-slate-600">Pending friend request</h1>
                    <div class="mt-4 space-y-3">
                        @foreach($pendingFriends as $pendingFriend)
                            <div>{{$pendingFriend->name}} ({{$pendingFriend->email}})
                ...
                <div>
                    ...
                    <div class="mt-4 space-y-3">
                        @foreach($requestingFriends as $requestingFriend)
                            <div>{{$requestingFriend->name}} ({{$requestingFriend->email}})</div>
